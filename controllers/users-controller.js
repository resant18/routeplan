...
//     if (!validateEmail(appReq.body.email))
//       return appRes.status(400).send("Email is not of the valid format");
//     if (!validatePassword(appReq.body.password)) {
//       return appRes
//         .status(400)
//         .send(
//           "Password should have minimum length of 6 & it should have atleast one letter, one number, and one special character"
//         );
//     }
//   } else {
...
//   User.findById(appReq.userId, { password: 0 }, (err, user) => {
//     if (err)
//       return appRes
//         .status(500)
//         .send("There was a problem with finding the user.");
...
//       });
//   } else if (appReq.body.name) {
//     // handle name only update
//     usersControllerEE.emit("update");
//   } else {
//     // only email update requested but invalid email
//     appRes.status(400).send("Email is not of the valid format!");
//   }
// };
